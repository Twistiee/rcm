...
P("R_AH2", 67.0, 11.0, 90)
P("R_AH3", 73.0, 11.0, 90)
P("R_AL1", 64.0, 11.0, 90)
P("R_AL2", 70.0, 11.0, 90)
P("R_AL3", 76.0, 11.0, 90)

P("U_CAN", 104.0, 12.0, 0)
P("C_CAN", 110.0, 12.0, 90)
P("R_TERM", 103.0, 18.0, 0)
P("R_TJ", 108.0, 18.0, 0)
P("R_RS", 113.0, 18.0, 0)
P("D_CAN", 118.0, 18.0, 0)

P("U_IMU", 105.0, 26.0, 0)
P("C_IMU1", 111.0, 25.0, 90)
P("C_IMU2", 111.0, 28.5, 90)
P("R_ADDR", 116.0, 25.0, 90)
P("R_ADDR_ALT", 116.0, 28.5, 90)
P("R_SDA", 121.0, 25.0, 90)
P("R_SCL", 121.0, 28.5, 90)

P("U_EEP", 104.0, 33.0, 0)
P("C_EEP", 110.0, 33.0, 90)
P("R_OE", 116.0, 33.0, 90)
